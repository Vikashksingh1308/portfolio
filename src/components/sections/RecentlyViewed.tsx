...
export default function RecentlyViewed({ slugs }: RecentlyViewedProps) {
  ...
  return (
    <section className="py-12 px-4 sm:px-6 max-w-5xl mx-auto border-t border-[var(--border)]">
      ...
      <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-none">
        {projects.map((project) => (
          <Link
            ...
            className="shrink-0 flex items-center gap-3 px-4 py-3 rounded-lg border border-[var(--border)] bg-[var(--surface)] hover:border-[var(--accent)] transition-colors group"
          >
            <div>
