    ...
    >
      ...
      >
        ...
        <div className="flex gap-4 items-start">
          <div className="shrink-0 flex items-center justify-center w-9 h-9 rounded-full bg-surface border border-border">
          ...
          <div>
            ...
            <p className="text-sm text-accent mt-0.5">
              ...
              <span className="text-muted"> · Galway, Ireland</span>
            </p>
